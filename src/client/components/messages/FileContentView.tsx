          ...
          <tbody>
            {parsedLines.map((line, i) => (
              <tr key={i}>
                ...
                {/* Render verbatim — React escapes text children, so tags/
                    generics like <div> or Array<string> must survive intact
                    (stripping them corrupted the shown file content, BUG MSG-6). */}
