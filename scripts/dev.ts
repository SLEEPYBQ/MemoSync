...
const clientEnv = {
  ...process.env,
  MEMOSYNC_DEV_ALLOWED_HOSTS: typeof devArgs.allowedHosts === "boolean"
    ? String(devArgs.allowedHosts)
    : JSON.stringify(devArgs.allowedHosts),
  MEMOSYNC_DEV_BACKEND_TARGET_HOST: devArgs.backendTargetHost,
  MEMOSYNC_DEV_BACKEND_PORT: String(serverPort),
}
